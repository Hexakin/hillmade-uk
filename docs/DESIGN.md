...
- **Tracking is optional, absent initially.** The previous global Vercel Analytics component/dependency is removed. Existing hosting request/security logs still exist; the site adds no advertising scripts, X scripts or analytics cookie banner.
