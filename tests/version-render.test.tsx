...
test("index labels the current chapter version and preview state", () => {
  const chapter = { ...chapterSchema.parse({ id: "one", slug: "one", number: 1, title: "Chapter One", description: "Draft", status: "public", preview: true, version: 1 }), body: "Text", file: "one.md", bodyAvailable: true };
